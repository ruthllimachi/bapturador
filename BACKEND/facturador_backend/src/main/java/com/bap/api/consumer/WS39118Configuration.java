...
@Configuration
public class WS39118Configuration {
	
    @Value("${client.ssl.trust-store-39118}")
    private Resource trustStore39118;
    ...
    private Jaxb2Marshaller jaxb2Marshaller() {
        ...
        jaxb2Marshaller.setContextPaths("com.api.fesc_39118");
        return jaxb2Marshaller;
    }

    @Bean
    @Qualifier("webServiceTemplate39118")
    public WebServiceTemplate webServiceTemplate39118() throws Exception {
...
//        webServiceTemplate.setDefaultUri("https://presiatservicios.impuestos.gob.bo:39118/FacturacionSincronizacion?wsdl");
    ...
    private SSLContext sslContext() throws Exception {
        return SSLContextBuilder.create()
                .loadKeyMaterial(trustStore39118.getFile(), trustStorePassword.toCharArray(),
                        trustStorePassword.toCharArray())
                .loadTrustMaterial(trustStore39118.getFile(), trustStorePassword.toCharArray()).build();
    }
