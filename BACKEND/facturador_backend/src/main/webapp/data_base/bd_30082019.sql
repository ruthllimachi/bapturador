...
CREATE TABLE `adm_persona` (
  ...
  CONSTRAINT `adm_persona_ibfk_1` FOREIGN KEY (`id_empresa`) REFERENCES `adm_empresa` (`id_empresa`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `api_cliente` (
  ...
  `id_empresa` bigint(20) NOT NULL,
  `codigo_cliente` varchar(100) CHARACTER SET utf8mb4 NOT NULL,
  ...
  `tipo_cliente` varchar(5) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `complemento` varchar(70) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `api_configuracion_punto_venta` (
  `id_configuracion_punto_venta` bigint(20) NOT NULL,
  `id_configuracion` bigint(20) NOT NULL,
...
CREATE TABLE `api_configuracion_sucursal` (
  `id_configuracion_sucursal` bigint(20) NOT NULL,
  `id_configuracion` bigint(20) NOT NULL,
...
CREATE TABLE `api_dosificacion_punto_venta` (
  `id_dosificacion_punto_venta` bigint(20) NOT NULL,
  `id_dosificacion` bigint(20) NOT NULL,
  `id_punto_venta` bigint(20) NOT NULL,
...
CREATE TABLE `api_dosificacion_sucursal` (
  `id_dosificacion_sucursal` bigint(20) NOT NULL,
  `id_dosificacion` bigint(20) NOT NULL,
  `id_sucursal` bigint(20) NOT NULL,
...
CREATE TABLE `api_factura` (
  ...
  `nombre_razon_social` varchar(200) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `id_cliente` bigint(20) NOT NULL,
  ...
  `tipoCambio` decimal(20,5) NOT NULL,
  ...
  `codigo_excepcion_documento` int(20) NOT NULL,
  ...
  CONSTRAINT `api_factura_ibfk_3` FOREIGN KEY (`id_cliente`) REFERENCES `api_cliente` (`id_cliente`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `api_sincronizacion` (
  ...
  `id_sincronizacion` bigint(20) NOT NULL,
...
INSERT INTO `api_sucursal` VALUES ('2019-08-12 17:29:16',NULL,NULL,'admin',NULL,NULL,10,1,0,'Sucursal Central','direccion sucursal','SI'),('2019-08-14 23:22:43',NULL,NULL,'admin',NULL,NULL,11,0,1,'Sucursal 1','asfafadfaf','NO'),('2019-08-15 07:20:24',NULL,NULL,'admin',NULL,NULL,12,1,1,'nuevo sucursal','direccion','NO');
...
-- Dump completed on 2019-08-30 10:41:17
