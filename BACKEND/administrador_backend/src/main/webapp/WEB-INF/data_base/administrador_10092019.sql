CREATE DATABASE  IF NOT EXISTS `dbo_administrador` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `dbo_administrador`;
-- MySQL dump 10.13  Distrib 5.5.62, for debian-linux-gnu (x86_64)
--
-- Host: 127.0.0.1    Database: dbo_administrador
-- ------------------------------------------------------
...
INSERT INTO `adm_persona` VALUES ('2019-01-01 00:00:00',NULL,NULL,'admin',NULL,NULL,2,1,'administrador','111'),('2019-01-01 00:00:00',NULL,NULL,'admin',NULL,NULL,3,1,'perador','2222');
...
CREATE TABLE `adm_session` (
  ...
  KEY `adm_session_usuario_ibfk_1` (`id_usuario`),
  CONSTRAINT `adm_session_usuario_ibfk_1` FOREIGN KEY (`id_usuario`) REFERENCES `adm_usuario` (`id_usuario`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `adm_usuario` VALUES ('2019-01-01 00:00:00',NULL,NULL,'admin',NULL,NULL,2,'admin','admin','2020-12-30 00:00:00',2,'ACTIV',NULL,10),('2019-01-01 00:00:00',NULL,NULL,'admin',NULL,NULL,3,'sucu','sucu','2020-12-30 00:00:00',3,'ACTIV',3,10);
...
/*!50001 CREATE TABLE `par_estado_usuario` (
...
/*!50001 DROP TABLE IF EXISTS `par_estado_usuario`*/;
/*!50001 DROP VIEW IF EXISTS `par_estado_usuario`*/;
...
-- Dump completed on 2019-09-10 22:45:03
