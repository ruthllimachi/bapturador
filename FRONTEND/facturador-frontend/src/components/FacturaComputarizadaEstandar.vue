  ...
  <v-card>
    ...
    <template v-slot:top>
      <v-toolbar flat color="white">
        <v-toolbar-title> Lista de Facturas Computarizada Estandar</v-toolbar-title>
        <v-divider
          class="mx-4"
          inset
          vertical
        ...
        <v-dialog v-model="dialog" max-width="80%">         
          <v-card>
            <v-card-title>
              <span class="headline">Factura Computarizada Estandar</span>
            </v-card-title>
     ...
     methods: {
      ...
      descargarReporte (item) {
        ...
        .then(response => {            
            ...
            a.href = url;
            a.download = 'FacturaComputarizada.pdf'
            a.click();
        })       
        .catch(e => { console.error(e)});                    
      },
