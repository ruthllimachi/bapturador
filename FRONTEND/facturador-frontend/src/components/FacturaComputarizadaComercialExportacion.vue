  ...
  <v-card>
    ...
    <template v-slot:top>
      <v-toolbar flat color="white">
        <v-toolbar-title> Lista de Facturas Computarizada Comercial Exportaci&oacute;n </v-toolbar-title>
        <v-divider
          class="mx-4"
          inset
          vertical
        ...
        <v-dialog v-model="dialog" max-width="80%">         
          <v-card>
            <v-card-title>
              <span class="headline">Facturas Computarizada Comercial Exportaci&oacute;n</span>
            </v-card-title>
